(function () {
    ...
    HomeCtrl.$inject = ['$scope', '$timeout', 'ENV', '$filter', '$rootScope', '$uibModal', '$log', 'GlobalUtils'];
    function HomeCtrl($scope, $timeout, ENV, $filter, $rootScope, $uibModal, $log, GlobalUtils) {
        var vm = this,
