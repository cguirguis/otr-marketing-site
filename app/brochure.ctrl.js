(function () {
    ...
    angular
        .module('brochure')
        .factory("UtilitiesService", ['$http', '$timeout', '$window', function($http, $timeout, $window) {
            var fightTicket = function() {
                var appUrl = showMobileWebApp()
            ...
            return {
                ...
                showMobileWebApp: showMobileWebApp
            };
        }])
    ...
    BrochureCtrl.$inject = ['ENV', '$http', '$q', '$modal', '$log', '$scope', 'UtilitiesService'];
    function BrochureCtrl(ENV, $http, $q, $modal, $log, $scope, UtilitiesService) {
        var vm = this,
        ...
        vm.fightTicket = UtilitiesService.fightTicket;
        ...
        $scope.isMobile = UtilitiesService.showMobileWebApp();
    ...
    ContentCtrl.$inject = ['ENV', '$http', '$q', '$modal', '$log', '$timeout', '$window', '$scope'];
    function ContentCtrl(ENV, $http, $q, $modal, $log, $timeout, $window, $scope) {
        var vm = this;
    ...
    StateInfoCtrl.$inject = ['ENV', '$routeParams', 'UtilitiesService'];
    function StateInfoCtrl(ENV, $routeParams, UtilitiesService) {
        var vm = this,
